...
export const ui = {
  ru: {
    ...
    about_text_1: "ООО «Промышленность и технологии» — промышленный холдинг, специализирующийся на добыче и реализации угля. Ключевой актив — предприятие ООО УК «Анжерская-Южная».",
  ...
  en: {
    ...
    about_text_1: "INDUSTRY AND TECHNOLOGY LLC is an industrial holding specializing in coal mining and sales. Key asset: MC Anzherskaya-Yuzhnaya LLC.",
  ...
  zh: {
    ...
    about_text_1: "“工业与技术”有限责任公司是一家专门从事煤炭开采和销售的控股公司。核心资产：Anzherskaya-Yuzhnaya LLC 矿业。",
  ...
  hi: {
    ...
    about_text_1: "उद्योग और प्रौद्योगिकी एलएलसी कोयला खनन और बिक्री में विशेषज्ञता वाला एक औद्योगिक होल्डिंग है। मुख्य संपत्ति: एमसी अंज़ेर्सकाया-युज़नाया एलएलसी।",
  ...
  ar: {
    ...
    about_text_1: "الصناعة والتكنولوجيا ذ.م.م هي شركة قابضة متخصصة في تعدين وبيع الفحم. الأصل الرئيسي: منجم Anzherskaya-Yuzhnaya LLC.",
